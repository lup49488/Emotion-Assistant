...
const server = http.createServer(async (request, response) => {
  ...
  if (request.method === 'GET' && url.pathname === '/api/v1/model/providers') return send(response, 200, {
    providers: [
      { id: 'deepseek', label: 'DeepSeek', kind: 'openai_compatible', models: ['deepseek-flash', 'deepseek-v4-pro'], default_model: 'deepseek-flash', default_base_url: 'https://api.deepseek.com', api_key_envs: ['DEEPSEEK_API_KEY', 'LLM_API_KEY'] },
      { id: 'openai', label: 'OpenAI', kind: 'openai_compatible', models: ['gpt-6-luna', 'gpt-6-sol', 'gpt-4o'], default_model: 'gpt-6-luna', default_base_url: '', api_key_envs: ['OPENAI_API_KEY', 'LLM_API_KEY'] },
      { id: 'openrouter', label: 'OpenRouter', kind: 'openai_compatible', models: ['openrouter/auto', 'openrouter/free'], default_model: 'openrouter/auto', default_base_url: 'https://openrouter.ai/api/v1', api_key_envs: ['OPENROUTER_API_KEY', 'LLM_API_KEY'] },
